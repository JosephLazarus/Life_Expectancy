...
knnt3 <- knnreg(x= cs.training.data[,-1], y=cs.training.data[,1], k=38)
...
# to get 38 re run above code with K=38
...
knn5var.AIC <- AIC(data.mod5var.knnt3$observed, data.mod5var.knnt3$predicted, nrow(data.mod5var.knnt3), 5)

knn5var.BIC <- BIC(data.mod5var.knnt3$observed, data.mod5var.knnt3$predicted, nrow(data.mod5var.knnt3), 5)

table(knn.38AIC, knn.38BIC, knn.1AIC, knn.1BIC, knn5var.AIC, knn5var.BIC)
```